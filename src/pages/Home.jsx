...
import homptonImage from '/Assg2/src/assets/hompton-by-the-beach.jpg';
import bertamImage from '/Assg2/src/assets/bertam-resort-water-park.jpg';
import bertamImage2 from '/Assg2/src/assets/angsana-teluk-bahang.jpg';
import "./Home.css"
function Home() {
    const hotels = [
        {
    ...
    const highlights = [
        {
            ...
            image: "/Assg2/src/assets/nightmarket.jpg",
        },
        {
            title: "2. Fruits",
            ...
            image: "/Assg2/src/assets/fruit.jpeg",
        },
        {
            title: "3. Culture",
            ...
            image: "/Assg2/src/assets/culture.jpg",
        },
        {
            title: "4. History",
            ...
            image: "/Assg2/src/assets/history.jpg",
        },
    ];
            ...
            <Carousel>
                <Carousel.Item>
                    <img
                        ...
                        src="/Assg2/src/assets/penang1.jpg"
                        alt="First image"
                    />
                    <Carousel.Caption>
                ...
                <Carousel.Item>
                    <img
                     style={{ height: "550px" }}
                        className="d-block w-100"
                        src="/Assg2/src/assets/penang.jpg"
                        alt="Second image"
                    />
                    <Carousel.Caption>
                ...
                <Carousel.Item>
                    <img
                     style={{ height: "550px" }}
                        className="d-block w-100"
                        src="/Assg2/src/assets/peanng3.png"
                        alt="Third image"
                    />
                    <Carousel.Caption>
                        <h3>Welcome To Penang!</h3>
            ...
            <section>
                ...
                <div className="scenic-container">
                    <div className="scenic-card">
                        <img src="/Assg2/src/assets/penanghill.jpeg" alt="景点111111111111" />
                        <h3>Penang Hill</h3>
                    ...
                    <div className="scenic-card">
                        <img src="/Assg2/src/assets/kekloksi.jpeg" alt="景点2111111111111111111" />
                        <h3>Kek Lok Si</h3>
                        <p>
                    ...
                    <div className="scenic-card">
                        <img src="/Assg2/src/assets/street art.jpg" alt="景点3111111111111111" />
                    ...
                    <div className="scenic-card">
                        <img src="/Assg2/src/assets/batu-ferringhi-beach.jpg" alt="景点4" />
        ...
        <section>
            ...
            <div className="food-container">
                <div className="food-card">
                    <img src="/Assg2/src/assets/Char_kway_teow.jpg" alt="火锅" />
                ...
                <div className="food-card">
                    <img src="/Assg2/src/assets/Nyonya_Laksa.jpg" alt="小面" />
                    <h3>Laksa</h3>
                    <p>
                ...
                <div className="food-card">
                    <img src="/Assg2/src/assets/Chendol.jpg" alt="豆花" />
                    <h3>Cendol</h3>
                    <p>
                ...
                <div className="food-card">
                    <img src="/Assg2/src/assets/Penang-style_Hokkien_mee.jpg" alt="山城啤酒" />
            ...
            <div className="categories">
                <div className="category">
                    ...
                    <div className="card-container">
                        <div className="card">
                            <img src="/Assg2/src/assets/currymee.jpeg" alt="重庆火锅" />
                            <h4>White Curry Mee</h4>
                            <p>Spicy, flavorful, coconut-based noodles.</p>
                        </div>
                        <div className="card">
                            <img src="/Assg2/src/assets/roticanai.jpg" alt="重庆小面" />
                            <h4>Roti Canai</h4>
                            <p>
                            Crispy, flaky, savory flatbread.</p>
                        </div>
                        <div className="card">
                            <img src="/Assg2/src/assets/nasikandar.jpg" alt="烤鱼" />
                            <h4>Nasi Kandar</h4>
                ...
                <div className="category">
                    ...
                    <div className="card-container">
                        <div className="card">
                            <img src="/Assg2/src/assets/tarik.jpeg" alt="山城啤酒" />
                            <h4>Teh Tarik</h4>
                        ...
                        <div className="card">
                            <img src="/Assg2/src/assets/coffee.jpeg" alt="盖碗茶" />
                        ...
                        <div className="card">
                            <img src="/Assg2/src/assets/bandung.jpeg" alt="酸梅汤" />
                            <h4>Air Bandung</h4>
